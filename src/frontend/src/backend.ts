...
export class Backend implements backendInterface {
    ...
    async analyzeImage(arg0: Uint8Array): Promise<StyleRecommendation> {
    ...
    async getRecentRecommendations(): Promise<Array<StyleRecommendation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentRecommendations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
